...
public class JudgeService {
    ...
    public void judgeSubmissionAsync(Long submissionId) {
        try {
            ...
            boolean isAccepted = analyzeCode(code, problem);
    ...
    private boolean analyzeCode(String code, Problem problem) {
        ...
        if (code.contains("scanner") || code.contains("input") || code.contains("cin")) {
